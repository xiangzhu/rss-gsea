...
To help decide the grid for `theta` in Round 2 enrichment analysis (Section \@ref(load2013-2)), I looked at the posterior mean, 95% lower and upper bound of `theta` for the top 100 enriched pathways identified in Round 1 analysis.
