...
To help decide the grid for `theta` in Round 2 enrichment analysis (Section \@ref(rbc2012-2)), I visualized the posterior mean, 95% lower and upper bound of `theta` for the top 100 enriched pathways identified in Round 1 analysis.
...
```{r, include=FALSE}
gtex.path <- "~/Dropbox/rss/Data/rbc_2012/pathway/rbc2012_gtexclust_201604.mat"
