...
To perform GSEA, I set `(h=0.3, theta0=-3)`, since the null analysis suggests that almost 99.4% posterior mass is placed on this setting. For the log-fold enrichment parameter, I use the grid `theta=(0:0.015:3)'`. The following table lists the GSEA results. 
```{r, eval=FALSE}
