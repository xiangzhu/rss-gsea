...
enrichment and prioritization analyses described in the manuscript:
...
illustrating how to use this software to perform the reported genome-wide
...
- [Adult human height (Wood et al. 2014) & Endochondral ossification]()
- [Inflammatory bowel disease (Liu et al. 2015) & Cytokine-cytokine receptor interaction]()
- [Rheumatoid arthritis (Okada et al. 2014) & Lymphocyte NFAT-dependent transcription]()
- [Coronary artery disease (Nikpay et al. 2015) & p75(NTR)-mediated signaling]()
- [High-density lipoprotein (Teslovich et al. 2010) & Lipid digestion, mobilization and transport]()
...
I sincerely hope that this change can address the referee's comment.
