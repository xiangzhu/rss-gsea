...
**please kindly cite our manuscript listed above, [Zhu and Stephens (2018)][]**.
...
- How can I perform similar analyses on a new dataset of GWAS summary statistics using RSS-E?
...
We used [`ggplot2::geom_density`][] (default setting) in the present study.  
