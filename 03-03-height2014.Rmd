...
From the Round 1 null analysis (Section \@ref(height2014-1)), I found that almost 100% posterior mass is concentrated on the setting `(h=0.3, theta0=-2)`. In Round 2, I used a finer grid. Specifically, I used the grids `theta0=(-2.25:0.025:-1.75)'` and `h=(0.3:0.1:0.4)'` when fitting the null model. I estimated the (unnormalized) log importance weights ("pseudo-likelihoods") for all 42 sets of `(h,theta0)` under null. 
