...
```{r,echo=FALSE}
knitr::include_graphics("images/height2014_null_round1.png", dpi=NA)
```
...
To help decide the grid for `theta` in Round 2 enrichment analysis (Section \@ref(height2014-3)), I visualized the posterior mean, 95% lower and upper bound of `theta` for the top 100 enriched pathways identified in Round 1 analysis.
...
```{r, include=FALSE}
gtex.path <- "~/Dropbox/rss/Data/height_2014/pathway/jobscripts_201601/height2014_gtexclust_201604.mat"
