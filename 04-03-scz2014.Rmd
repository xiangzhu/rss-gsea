...
```{r, include=FALSE}
gsea.path <- "~/Dropbox/rss/Data/scz_2014/pathway/scz2014_pathway_201604.mat"
...
plotly::plot_ly(data=bf.df, x=round1.log10.bf, y=round2.log10.bf, mode="markers",
                text=paste0("ID: ",id,"; Name: ",name), color=numsnps, size=numgene) %>% add_trace(x=c(0,3.5), y=c(0,3.5), mode="lines") %>% add_trace(x=round1.log10.bf, y=fitted(fit), mode="lines") %>% layout(showlegend = F) 
```
