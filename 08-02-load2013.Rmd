...
```{r,echo=FALSE}
knitr::include_graphics("images/load2013_null_round1.png", dpi=NA)
```
...
To help decide the grid for `theta` in Round 2 enrichment analysis (Section \@ref(load2013-2)), I visualized the posterior mean, 95% lower and upper bound of `theta` for the top 100 enriched pathways identified in Round 1 analysis.
...
```{r, include=FALSE}
gtex.path <- "~/Dropbox/rss/Data/load_2013/pathway/load2013_gtexclust_201604.mat"
